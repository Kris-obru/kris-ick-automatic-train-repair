...
> **Historical document** for the 1.1.4 → 2.0.0 port. Current shipping version is **2.1.0** (`kris-ick-automatic-train-repair`). Prefer `README.md`, `changelog.txt`, and `info.json` for present-day behavior.
